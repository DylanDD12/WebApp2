function showSuggestions(username) {
    ...
    if (input.length > 0) {
        ...
        fetch('/get_group_suggestions?search_term=' + input)
            ...
            .then(data => {
                ...
                data.forEach(function (suggestion) {
                    ...
                    suggestionElement.onclick = function () {
                        navigateToGroup(suggestion, username); // Call a function to navigate to the profile
                    };
...
function navigateToGroup(groupName, username) {
    // Modify this function to navigate to the desired URL
    window.location.href = '/group/' + groupName + '/' + username;
}
